        ...
        <aside class="w-64 bg-indigo-700 shadow-lg hidden lg:block">
            ...
            <nav class="mt-6">
                <div class="px-4 space-y-2">
                    ...
                    <a href="logout.php" class="block px-4 py-2 text-indigo-200 hover:bg-indigo-600 hover:text-white rounded-lg flex items-center gap-2">
        ...
        <div class="space-y-2">
            ...
            <p class="text-gray-800">3. Emma Wilson</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex-1">
                                        <p class="font-semibold text-gray-800">Advanced JavaScript Masterclass</p>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                        <div class="p-6 border-b">
                            <h2 class="text-xl font-bold text-gray-800">Top Teachers</h2>
                        </div>
                        <div class="p-6">
                            <div class="space-y-6">
                ...
                <!-- Tags Management -->
                <div class="bg-white rounded-xl shadow-sm mt-6 border border-gray-100">
                    <div class="p-6 border-b">
                        <h2 class="text-xl font-bold text-gray-800">Tags Management</h2>
                    </div>
                    <div class="p-6">
                        <!-- Bulk Tag Input -->
                        <div class="mb-6">
                            <label for="bulkTags" class="block text-sm font-medium text-gray-700 mb-2">Add Multiple Tags</label>
                            <div class="flex gap-4">
                                <input type="text" id="bulkTags"
                                    class="flex-1 rounded-lg border-gray-300 focus:border-indigo-600 focus:ring-indigo-600"
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm bg-indigo-100 text-indigo-600">
                                    JavaScript
