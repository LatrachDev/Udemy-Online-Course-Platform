...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="bg-white shadow">
        ...
        <nav class="space-x-6">
            <a href="#about" class="hover:text-blue-600">My courses</a>
    ...
    <section class="bg-blue-600 text-white py-16">
        <div class="container mx-auto text-center">
            ...
            <a href="signup.php" class="bg-white text-blue-600 px-6 py-3 rounded font-medium shadow-md hover:bg-gray-200">Go to my courses</a>
        </div>
    </section>
